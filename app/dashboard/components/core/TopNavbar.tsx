...
import CustomizationModal from '@/app/dashboard/components/modals/CustomizationModalComponent';
              ...
              <div className="hidden sm:flex sm:items-center">
                ...
                {onToggleReorderMode !== undefined && (
                  <button
                    type="button"
                    onClick={handleReorderModeToggle}
                    className={`ml-3 inline-flex items-center px-4 py-2 border ${isReorderModeActive
