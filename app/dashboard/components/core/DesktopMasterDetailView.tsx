...
import { useModalState, ItemType } from '@/app/dashboard/hooks/ui/useModalState';
import { Category, Section, Product } from '@/app/dashboard/types';

import { CategoryGridView } from '../domain/categories/CategoryDesktopMixedGrid';
import { SectionGridView } from '../domain/sections/SectionDesktopMixedGrid';
import { ProductGridView } from '../domain/products/ProductDesktopSimpleGrid';
import { EditCategoryModal, EditSectionModal, EditProductModal } from '../modals/EditModalComponents';
import { DeleteConfirmationModal } from '../modals/DeleteConfirmationModalComponent';
