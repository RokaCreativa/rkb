...
import { useI18n } from '@/app/dashboard/hooks/ui/useI18n';
      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div
              className={`pointer-events-none fixed inset-y-0 ${position}-0 flex max-w-full ${position === 'left' ? 'pr-10' : 'pl-10'
                }`}
            >
              ...
              >
                ...
                >
                  ...
                  <div className={`flex h-full flex-col overflow-y-auto bg-white shadow-2xl ${position === 'right' ? 'rounded-l-2xl' : 'rounded-r-2xl'
                    }`}>
                          ...
                          {itemsToShow.map((item) => (
                            <div key={item.id} className="relative">
                              ...
                              <button
                                ...
                                className={`group relative w-full text-base py-4 px-4 rounded-lg flex items-center justify-start text-left transition-all duration-150 ${item.isActive
